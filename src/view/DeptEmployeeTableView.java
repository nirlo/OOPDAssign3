 ...
 * @author Shariar
 */
public class DeptEmployeeTableView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Logic<DeptManager> logic = new DeptManagerLogic();
            List<DeptManager> list  = logic.getAll();
            ...
            for (DeptManager e : list) {
                out.printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", 
                		e.getDeptNo(), e.getEmpNo(), e.getFromDate(), e.getToDate());
            }
